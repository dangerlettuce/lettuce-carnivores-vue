<template>
  <div class="container">
    <form>
      <div>
        <label v-if="surveyData.great === true" for="additional-comments"
          >Thanks for letting us know how your order went! Please share any additional comments below.</label
        >
        <label v-if="surveyData.great === false" for="additional-comments"
          >We're sorry your order didn't meet your expectations. Please let us know what we can do better.
        </label>
        <textarea
          id="additional-comments"
          rows="6"
          v-model="surveyData.additionalComments"
          @change="
            () => {
              isSaved = false;
            }

<template>
  <div class="text-center mt-4">
    ...
    <div class="my-3">
      ...
      <p v-else>
        Cold weather shipping - shipping will be planned to avoid very cold temperatures. A heat pack and insulation will be included when
        necessary. All orders are covered by our live arrival guarantee. If temperatures are very cold for an extended duration, we will
        contact you to discuss or you can reach out to us via email or Instagram
      </p>
      <div class="mb-2">

...
export default abstract class Restful extends Api {
  ...
  public async enrichRequestConfig(apiRequest: ApiRequest, payload: any = null, apiConfig: Required<RestfulApiConfig> = this.apiConfig) {
  ...
  private async request(apiRequest: ApiRequest, apiConfig: RestfulApiConfig = this.apiConfig, refreshToken = false): Promise<any> {

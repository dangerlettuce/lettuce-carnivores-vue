<template>
  <div class="form-container">
    ...
    <FormKit type="form" :actions="false">
      ...
      <FormKit type="text" name="email" label="Email" outer-class="mb-3" validation="email|required" v-model="formData.email" />
      <FormKit
        type="text"
      ...
      />
      <p>
        The information provided will only be used to facilitate the giveaway. This information will NEVER be used for marketing or
        sold/shared with any third parties. Your information will be deleted within 60 days of the close of the giveaway.
      </p>
      <FormKit type="submit">
...
async function submitHandler() {
  try {
    ...
    if (res.success) {
      ...
      toast.error(`This entry appears to be a duplicate. Please contact support@dangerlettuce.com if you believe this is not correct.`, {
        autoClose: false,
      });
    } else {
      toast.error(`Something went wrong: \n${res.message}. Please try again or contact support@dangerlettuce.com.`, { autoClose: false });

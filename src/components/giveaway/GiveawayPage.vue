    ...
    <div class="giveaway-header">
      <div class="giveaway-body">
        ...
        <Transition>
          <div v-show="showHelp">
            <p>
              {{ gameHelpLine1 }} <span><BaseButton @click.prevent="" type="treat">Treat</BaseButton></span> button on any of the 'View
              Details' pages.
            </p>
            <p>{{ gameHelpLine2 }}</p>
            <p v-if="isGameActive">
              Not interested in playing the game? <BaseButton size="small" @click="setBypassGame">Click here</BaseButton> to skip it and
              enter the contest
            </p>
          </div>
        </Transition>

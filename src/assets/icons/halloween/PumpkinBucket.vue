<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 1000 1000">
    <defs></defs>
    <title>pumpkin bucket</title>
    <g>
      <path
        class="st0"
        d="M354.6,290.1c33.8-2.3,67.6,2.7,100.3,11.3c23.6-4,45.5-6.7,67.3-7.9l0,0c6.9-0.4,13.9-0.6,20.7-0.7l0,0
      ...
      <polygon
        points="198.7,695.8 288.2,701.9 302.9,759.2 377.3,737.2 441.2,788.3 511.4,741.8 601.6,788.3 665,722.9 733.5,752.1 
            800.6,679.5 768.7,799.1 674.3,784.2 620.9,873.1 511.4,833.3 452.8,873.1 384.6,829.7 278.3,823 260,742.8 	"
      />
      <path
        class="st2"
        d="M870.5,392.6c-0.1-49.4-9.2-97.5-27-143.1c-17.3-44.3-41.9-84.1-73.2-118.5c-31.6-34.6-68.3-61.8-109-80.8
